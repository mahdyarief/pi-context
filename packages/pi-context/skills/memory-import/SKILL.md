---
name: memory-import
description: Import durable knowledge from URLs, folders, or files into pi-context memory. Use when the user asks to preserve external content as memory.
---
...
- If it has markdown frontmatter, preserve useful metadata but normalize to pi-context memory format.
